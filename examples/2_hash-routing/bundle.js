...
/* 2_hash-routing/src/App.svelte generated by Svelte v3.20.1 */
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			t4 = space();
			p = element("p");
			p.textContent = "The Router can be configured to use hash instead of pathname (useHash = true\n  when declaring the Router)";
			t6 = space();
			main = element("main");
			section = element("section");
