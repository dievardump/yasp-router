...
/* 3_nested-routes/src/App.svelte generated by Svelte v3.20.1 */
...
// (35:6) <Link to="/landing/article-1">
...
// (36:6) <Link to="/landing/article-2">
...
// (38:8) <Route path="/landing/article-1">
function create_default_slot_7(ctx) {
	let t;

	return {
		c() {
			t = text("Content article 1");
		},
		m(target, anchor) {
			insert(target, t, anchor);
		},
...
// (39:8) <Route path="/landing/article-2">
function create_default_slot_6(ctx) {
	let t;

	return {
		c() {
			t = text("Content article 2");
		},
		m(target, anchor) {
			insert(target, t, anchor);
		},
...
// (32:4) <Route path="/landing" let:match>
function create_default_slot_5(ctx) {
	let t0_value = /*match*/ ctx[0] + "";
	let t0;
	let t1;
	let h1;
	let t3;
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*match*/ 1) && t0_value !== (t0_value = /*match*/ ctx[0] + "")) set_data(t0, t0_value);
			const link0_changes = {};
...
// (49:8) <Route path="/landing/article-1">
function create_default_slot_4(ctx) {
	let t;

	return {
		c() {
			t = text("Similar content article 1");
		},
		m(target, anchor) {
			insert(target, t, anchor);
		},
...
// (50:8) <Route path="/landing/article-2">
function create_default_slot_3(ctx) {
	let t;

	return {
		c() {
			t = text("Similar content article 2");
		},
		m(target, anchor) {
			insert(target, t, anchor);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			t5 = space();
			p = element("p");
			p.textContent = "Routes can be nested without problems.";
			t7 = space();
			main = element("main");
			section = element("section");
			create_component(route0.$$.fragment);
