...
/* 1_simple-routing/src/App.svelte generated by Svelte v3.20.1 */
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			t4 = space();
			p = element("p");
			p.textContent = "This Router will render any Route that match the current URL.";
			t6 = space();
			main = element("main");
			section = element("section");
